...
<html lang="en">
    ...
    <body>
        ...
        <footer>
            olback &copy; <?php echo date('Y'); ?><br>Please contribute on <i class="fa fa-github" aria-hidden="true" style="color:#333;"></i> <a href="https://github.com/olback/o-todo" target="_blank" class="contribute">Github</a>!
        </footer>
